    ...
    public void onFirstSpawn() {
        ...
        if (alphaInfo != null) {
            ...
            if (this.getRandom().nextFloat() <= alphaChance) {
                EntityJousteAlpha alpha = (EntityJousteAlpha) CreatureManager.getInstance().getCreature("joustealpha").createEntity(this.level());
                alpha.copyPosition(this);
                DeferredLevelActionManager.spawnEntity(this.level(), this.blockPosition(), null, alpha);
