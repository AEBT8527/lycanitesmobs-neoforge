			...
			for(LivingEntity possibleTarget : possibleTargets) {
				...
				if(doDamage) {
					if (ObjectManager.getEffect("paralysis") != null)
						possibleTarget.addEffect(new MobEffectInstance(ObjectManager.holder(ObjectManager.getEffect("paralysis")), this.getEffectDuration(5), 1));

					if (ObjectManager.getEffect("aphagia") != null)
						possibleTarget.addEffect(new MobEffectInstance(ObjectManager.holder(ObjectManager.getEffect("aphagia")), this.getEffectDuration(5), 1));
					else
