...
public class EntitySalamander extends RideableCreatureEntity implements Enemy {
    ...
    public void specialAttack() {
        ...
        List<LivingEntity> possibleTargets = this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(distance, distance, distance), new Predicate<LivingEntity>() {
            @Override
