...
public class EntityThresher extends RideableCreatureEntity implements Enemy, IGroupHeavy {
            ...
            if (this.canWhirlpool()) {
                for (Entity entity : this.getNearbyEntities(Entity.class, null, this.whirlpoolRange)) {
                    ...
                    if (entity instanceof LivingEntity) {
                        ...
                        if (entityLivingBase.hasEffect(ObjectManager.holder(ObjectManager.getEffect("weight"))) || !this.canAttack(entityLivingBase))
                            continue;
                    }
    ...
    public void riderEffects(LivingEntity rider) {
        ...
        if (rider.hasEffect(ObjectManager.holder(ObjectManager.getEffect("paralysis"))))
            rider.removeEffect(ObjectManager.holder(ObjectManager.getEffect("paralysis")));
        if (rider.hasEffect(ObjectManager.holder(ObjectManager.getEffect("penetration"))))
            rider.removeEffect(ObjectManager.holder(ObjectManager.getEffect("penetration")));
    }
