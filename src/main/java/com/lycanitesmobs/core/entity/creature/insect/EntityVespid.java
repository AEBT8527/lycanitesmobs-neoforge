...
public class EntityVespid extends AgeableCreatureEntity implements Enemy {
    ...
    public void aiStep() {
        ...
        // Building AI:
        if (!this.level().isClientSide() && this.hiveBuilding && this.getMasterTarget() instanceof EntityVespidQueen && !this.aiPlaceBlock.hasBlockPlacement()) {
        ...
        if (!this.level().isClientSide() && this.getTarget() instanceof EntityConba) {
