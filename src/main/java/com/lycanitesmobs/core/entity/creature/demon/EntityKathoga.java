...
public class EntityKathoga extends RideableCreatureEntity {
    ...
    public void specialAttack() {
        ...
        List<LivingEntity> possibleTargets = this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(distance, distance, distance), (Predicate<LivingEntity>) possibleTarget -> {
