...
public class BaseProjectileEntity extends ThrowableProjectile {
    ...
    public void defineSynchedData(net.minecraft.network.syncher.SynchedEntityData.Builder builder) {
        // In 1.21 this runs during the Entity constructor, BEFORE this.entityData is assigned —
        // calling setProjectileScale() here (which does entityData.set) crashes with an NPE.
        // builder.define seeds the initial value; the scale setter is used post-construction.
