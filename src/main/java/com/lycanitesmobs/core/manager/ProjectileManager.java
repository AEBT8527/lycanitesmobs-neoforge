...
public class ProjectileManager extends JSONLoader {
    ...
    public void startup(ModInfo modInfo) {
        ...
        for (ProjectileInfo projectileInfo : this.projectiles.values()) {
            ...
            LycanitesMobs.ENTITY_TYPES.register(projectileInfo.getName(), () -> (EntityType<?>) b.build(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.ENTITY_TYPE, net.minecraft.resources.Identifier.fromNamespaceAndPath("lycanitesmobs", projectileInfo.getName()))));
        }
    ...
    public void bindRegisteredTypes() {
        for (ProjectileInfo projectileInfo : this.projectiles.values()) {
            Identifier id = AssetHelper.modResource(projectileInfo.getName());
    ...
    public EntityType createEntityType(String entityName, Class<? extends Entity> entityClass) {
        ...
        EntityType entityType = entityTypeBuilder.build(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.ENTITY_TYPE, net.minecraft.resources.Identifier.fromNamespaceAndPath("lycanitesmobs", entityName)));
