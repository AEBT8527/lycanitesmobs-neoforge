...
public class JSONHelper {
    ...
    public static List<Block> getJsonBlocks(JsonArray jsonArray) {
        ...
        while (jsonIterator.hasNext()) {
            Block block = BuiltInRegistries.BLOCK.get(ResourceLocation.parse(jsonIterator.next().getAsString()));
            if (block != null) {
                blocks.add(block);
            }
        }
    ...
    public static List<Item> getJsonItems(JsonArray jsonArray) {
        ...
        Iterator<JsonElement> jsonIterator = jsonArray.iterator();
        while (jsonIterator.hasNext()) {
            Item item = BuiltInRegistries.ITEM.get(ResourceLocation.parse(jsonIterator.next().getAsString()));
            if (item != null) {
                items.add(item);
            }
        }
    ...
    public static List<Biome> getBiomes(Level world, List<String> biomeIds) {
        ...
        for (String biomeId : biomeIds) {
            Biome biome = biomeRegistry.get(ResourceLocation.parse(biomeId));
            if (biome != null) {
                biomes.add(biome);
            }
        }
