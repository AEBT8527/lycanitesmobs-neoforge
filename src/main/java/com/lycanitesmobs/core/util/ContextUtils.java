...
public class ContextUtils {
    public static class AnimationContext {
        ...
        public AnimationContext(BaseCreatureEntity entity, float time, float distance, float loop, float lookY, float lookX, float scale, int brightness, Identifier texture) {
            this.entity = entity;
            this.time = time;
