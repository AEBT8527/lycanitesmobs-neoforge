...
public class ChargeItem extends BaseItem {
    ...
    public ChargeItem(Item.Properties properties, ProjectileInfo projectileInfo) {
        ...
        if (this.projectileInfo != null) {
            ...
            LMHelperClass.logDebug("Projectile", "Created Charge Item: " + projectileInfo.getChargeItemName());
        }
        // Dispenser:
    ...
    public List<MutableComponent> getAdditionalDescriptions(ItemStack itemStack, net.minecraft.world.item.Item.TooltipContext world, TooltipFlag tooltipFlag) {
