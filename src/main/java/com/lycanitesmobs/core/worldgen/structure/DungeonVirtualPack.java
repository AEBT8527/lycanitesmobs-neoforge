...
public class DungeonVirtualPack implements PackResources {
    ...
    private void generateBiomeTag(String name, List<String> biomeTags, List<String> biomeIds) {
        ...
        resources.put(
                ResourceLocation.fromNamespaceAndPath("lycanitesmobs", "tags/worldgen/biome/has_structure/" + name + ".json"),
                toBytes(tag)
        );
    }
    ...
    private void generateStructure(String name) {
        ...
        resources.put(
                ResourceLocation.fromNamespaceAndPath("lycanitesmobs", "worldgen/structure/" + name + ".json"),
                toBytes(structure)
        );
    }
    ...
    private void generateCombinedStructureSet(List<SchematicEntry> entries, int spacing, int separation, int salt) {
        ...
        resources.put(
                ResourceLocation.fromNamespaceAndPath("lycanitesmobs", "worldgen/structure_set/" + COMBINED_SET_NAME + ".json"),
                toBytes(set)
        );
    }
