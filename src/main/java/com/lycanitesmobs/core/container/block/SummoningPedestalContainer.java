...
public class SummoningPedestalContainer extends BaseContainer {
    public static final MenuType<SummoningPedestalContainer> TYPE = (MenuType<SummoningPedestalContainer>) IMenuTypeExtension.create(SummoningPedestalContainer::new);
    ...
    public SummoningPedestalContainer(int windowId, Inventory playerInventory, FriendlyByteBuf extraData) {
        this(windowId, playerInventory, (TileEntitySummoningPedestal) playerInventory.player.level().getBlockEntity(extraData.readBlockPos()));
    }
