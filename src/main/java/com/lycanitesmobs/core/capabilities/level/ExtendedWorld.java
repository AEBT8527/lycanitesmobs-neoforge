...
public class ExtendedWorld extends SavedData {
    ...
    public static ExtendedWorld getForWorld(Level world) {
        ...
        if (world instanceof ServerLevel) {
            ...
            ExtendedWorld worldSavedData = serverWorld.getDataStorage().get(
                    new SavedData.Factory<>(ExtendedWorld::new, (tag, provider) -> {
            ...
            if (worldSavedData != null) {
                ...
                serverWorld.getDataStorage().set(EXT_PROP_NAME, worldExt);
            }
        }
    ...
    // ==================================================
    @Override
    public CompoundTag save(CompoundTag nbtTagCompound, net.minecraft.core.HolderLookup.Provider provider) {
    ...
    public void buildDungeonInLoadedChunks(DungeonInstance instance) {
        ...
        for (int cx = instance.getChunkMin().x; cx <= instance.getChunkMax().x; cx++) {
            for (int cz = instance.getChunkMin().z; cz <= instance.getChunkMax().z; cz++) {
                ...
                RandomSource random = RandomSource.create(chunkPos.toLong() ^ this.getWorldSeed());
