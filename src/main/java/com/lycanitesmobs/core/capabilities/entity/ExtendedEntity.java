...
public class ExtendedEntity {
    ...
    public static final IAttachmentSerializer<CompoundTag, ExtendedEntity> SERIALIZER = new IAttachmentSerializer<>() {
        @Override
        public CompoundTag write(ExtendedEntity attachment, HolderLookup.Provider provider) {
        ...
        @Override
        public ExtendedEntity read(IAttachmentHolder holder, CompoundTag tag, HolderLookup.Provider provider) {
    ...
    public void onUpdate() {
        ...
        if (!this.entity.getCommandSenderWorld().isClientSide && !ExtendedEntity.getForceRemoveEntityIds().isEmpty() && !this.forceRemoveChecked) {
    ...
    public void setPickedUpByEntity(Entity pickedUpByEntity) {
        ...
        if (!this.entity.getCommandSenderWorld().isClientSide) {
            ...
            LycanitesMobs.PACKET_MANAGER.sendToWorld(message, this.entity.getCommandSenderWorld());
        }
