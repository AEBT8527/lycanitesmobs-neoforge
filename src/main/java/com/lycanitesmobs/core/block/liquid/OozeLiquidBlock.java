...
public class OozeLiquidBlock extends BaseLiquidBlock {
    public OozeLiquidBlock(Supplier<? extends FlowingFluid> fluidSupplier, Block.Properties properties, String name, ElementInfo element, boolean destroyItems) {
    ...
    protected void entityInside(BlockState blockState, Level world, BlockPos pos, Entity entity, net.minecraft.world.entity.InsideBlockEffectApplier lycEffectApplier, boolean lycIsPrecise) {
        ...
        if (entity instanceof LivingEntity) {
            ((LivingEntity) entity).addEffect(new MobEffectInstance(MobEffects.SLOWNESS, 5 * 20, 0));
        }
