...
public class PoisonLiquidBlock extends BaseLiquidBlock {
    public PoisonLiquidBlock(Supplier<? extends FlowingFluid> fluidSupplier, Properties properties, String name, ElementInfo element, boolean destroyItems) {
    ...
    @Override
    protected void entityInside(BlockState blockState, Level world, BlockPos pos, Entity entity, net.minecraft.world.entity.InsideBlockEffectApplier lycEffectApplier, boolean lycIsPrecise) {
        // Extinguish:
        if (entity.isOnFire())
            entity.clearFire();
        ...
        if (entity instanceof LivingEntity) {
            ...
            if (effect != null) {
                ((LivingEntity) entity).addEffect(new MobEffectInstance(ObjectManager.holder(effect), 5 * 20, 0));
            }
        }
