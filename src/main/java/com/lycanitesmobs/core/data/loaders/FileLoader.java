...
public class FileLoader {
    ...
    public FileLoader(String type, String domain) {
        ...
        try {
            ...
            switch (rootUri.getScheme()) {
                case "file", "union", "jar" -> {
                    // FML 11 (26.x) loads production mods with the plain "jar" scheme; make sure
                    // a zip filesystem is open for it before resolving the path.
     ...
     */
    public List<Identifier> getPathResourceLocations(String subPath, String fileType) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (fileType == null || fileType.equals(FilenameUtils.getExtension(filePath.toString()))) {
                    ...
                    Identifier resourceLocation = Identifier.fromNamespaceAndPath(this.domain, resourceLocationPath);
