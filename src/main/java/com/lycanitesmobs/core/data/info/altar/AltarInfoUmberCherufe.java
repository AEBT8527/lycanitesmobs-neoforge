...
public class AltarInfoUmberCherufe extends AltarInfo {
    ...
    public boolean activate(Entity entity, Level world, BlockPos pos, int variant) {
        ...
        // Spawn Mini Boss:
        entityLobber.markAltarSummoned();
        entityLobber.forceBossHealthBar();
        entityLobber.applyVariant(3);
        entityLobber.snapTo(x, y - 2, z, 0, 0);
        this.spawnDeferred(world, pos, "altar_spawn:" + this.name + ":" + pos.asLong(), entityLobber,
