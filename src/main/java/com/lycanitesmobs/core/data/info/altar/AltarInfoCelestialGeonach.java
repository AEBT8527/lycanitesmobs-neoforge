...
public class AltarInfoCelestialGeonach extends AltarInfo {
    ...
    public boolean activate(Entity entity, Level world, BlockPos pos, int variant) {
        ...
        // Spawn Mini Boss:
        entityGeonach.markAltarSummoned();
        entityGeonach.forceBossHealthBar();
        entityGeonach.applyVariant(3);
        entityGeonach.snapTo(x, y - 2, z, 0, 0);
        this.spawnDeferred(world, pos, "altar_spawn:" + this.name + ":" + pos.asLong(), entityGeonach,
