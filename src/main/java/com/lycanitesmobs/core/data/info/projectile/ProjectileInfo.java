...
public class ProjectileInfo {
    ...
    public void load() {
        ...
        if (!this.noChargeItem) {
            ...
            if (ObjectManager.getItem(this.chargeItemName) != null) {
                ...
                this.chargeItem = Lazy.of(() -> new ChargeItem(com.lycanitesmobs.core.util.helpers.LMHelperClass.itemId(properties, this.chargeItemName), this));
    ...
    public SimpleParticleType getParticleType() {
        ...
        if (this.particleType == null) {
            ParticleType<?> particleType = BuiltInRegistries.PARTICLE_TYPE.getValue(Identifier.parse(this.particleId));
    ...
    public SimpleParticleType getWaterParticleType() {
        ...
        if (this.waterParticleType == null) {
            ParticleType<?> particleType = BuiltInRegistries.PARTICLE_TYPE.getValue(Identifier.parse(this.waterParticleId));
            if (particleType instanceof SimpleParticleType) {
    ...
    public EntityType getEntityType() {
        this.entityType = (EntityType) BuiltInRegistries.ENTITY_TYPE.getValue(AssetHelper.modResource(this.getName()));
