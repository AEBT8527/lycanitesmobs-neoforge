...
public class AltarInfoCrimsonEpion extends AltarInfo {
    ...
    //                    Constructor
    // ==================================================
    public AltarInfoCrimsonEpion(String name) {
        super(name);
    }
    ...
    public boolean fullCheck(Entity entity, Level world, BlockPos pos) {
        ...
        // Upper:
        if(world.getBlockState(pos.offset(0, 2, 0)).getBlock() != Blocks.AIR)
            return false;
    ...
    public boolean activate(Entity entity, Level world, BlockPos pos, int variant) {
        ...
        // Create Mini Boss:
        BaseCreatureEntity entityCreature = (BaseCreatureEntity) CreatureManager.getInstance().getCreature("epion").createEntity(world);
