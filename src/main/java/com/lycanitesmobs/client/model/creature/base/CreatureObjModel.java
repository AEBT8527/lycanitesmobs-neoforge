...
public class CreatureObjModel extends CreatureModel {
    ...
    public CreatureObjModel initModel(String name, ModInfo modInfo, String path, ResourceManager resourceManager) {
        ...
        this.objModel = new VBOObjModel(
                Identifier.fromNamespaceAndPath(modInfo.modid, "modelparts/" + path + ".obj"),
                resourceManager
        );
        ...
        Identifier modelPartsLocation = Identifier.fromNamespaceAndPath(modInfo.modid, "modelparts/" + path + "_parts.json");
        try {
        ...
        Identifier animationLocation = Identifier.fromNamespaceAndPath(modInfo.modid, "modelparts/" + path + "_animation.json");
        try {
            Gson gson = (new GsonBuilder()).setPrettyPrinting().disableHtmlEscaping().create();
