...
public abstract class ItemObjModel implements IAnimationModel {
    ...
    public ItemObjModel initModel(String name, String path, ResourceManager resourceManager) {
        ...
        this.objModel = new VBOObjModel(Identifier.fromNamespaceAndPath(LycanitesMobs.MODID, "modelparts/" + path + ".obj"), resourceManager);
        ...
        Identifier animPartsLoc = Identifier.fromNamespaceAndPath(LycanitesMobs.MODID, "modelparts/" + path + "_parts.json");
        try {
        ...
        Identifier animationLocation = Identifier.fromNamespaceAndPath(LycanitesMobs.MODID, "modelparts/" + path + "_animation.json");
        try {
            Gson gson = (new GsonBuilder()).setPrettyPrinting().disableHtmlEscaping().create();
