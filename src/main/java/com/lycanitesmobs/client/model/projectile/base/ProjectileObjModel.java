...
public class ProjectileObjModel extends ProjectileModel {
    ...
    public void reloadModel(ResourceManager resourceManager) {
        ...
        this.wavefrontObject = new VBOObjModel(Identifier.fromNamespaceAndPath(this.modelModInfo.modid, "modelparts/" + this.modelPath + ".obj"));
        ...
        Identifier modelPartsLocation = Identifier.fromNamespaceAndPath(this.modelModInfo.modid, "modelparts/" + this.modelPath + "_parts.json");
        try {
            Gson gson = (new GsonBuilder()).setPrettyPrinting().disableHtmlEscaping().create();
            InputStream in = resourceManager.getResource(modelPartsLocation).get().open();
            BufferedReader reader = new BufferedReader(new InputStreamReader(in));
            try {
                JsonArray jsonArray = GsonHelper.fromJson(gson, reader, JsonArray.class);
                if (jsonArray != null) {
        ...
        Identifier animationLocation = Identifier.fromNamespaceAndPath(this.modelModInfo.modid, "modelparts/" + this.modelPath + "_animation.json");
        try {
            Gson gson = (new GsonBuilder()).setPrettyPrinting().disableHtmlEscaping().create();
