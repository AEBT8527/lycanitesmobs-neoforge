...
public abstract class CreatureFilterList extends BaseList<BeastiaryScreen> {
	 ...
	 */
	public void renderSlot(GuiGraphicsExtractor guiGraphics, int index, int top, int left, int bottom, int right) {}
	...
	public abstract static class Entry extends BaseListEntry {
		...
		public void render(GuiGraphicsExtractor guiGraphics, int index, int top, int left, int bottom, int right, int mouseX, int mouseY, boolean p_render_8_, float partialTicks) {
			this.parentList.renderSlot(guiGraphics, index, top, left, bottom, right);
		}
