...
public class ElementsBeastiaryScreen extends BeastiaryScreen {
    ...
    @Override
    protected void renderWidgets(GuiGraphicsExtractor matrixStack, int x, int y, float partialTicks) {
        this.elementList.extractWidgetRenderState(matrixStack, x, y, partialTicks);

        if (this.elementInfo != null) {
            this.descriptionList.setElementInfo(this.elementInfo);
            this.descriptionList.extractWidgetRenderState(matrixStack, x, y, partialTicks);
        }
    }

    @Override
    public void renderForeground(GuiGraphicsExtractor matrixStack, int x, int y, float partialTicks) {
