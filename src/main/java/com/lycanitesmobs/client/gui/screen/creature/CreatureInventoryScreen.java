...
public class CreatureInventoryScreen extends BaseContainerScreen<CreatureContainer> {
    ...
    public void renderBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        // Main GUI background (exactly like 1.16, but via GuiGraphicsExtractor)
        guiGraphics.blit(
    ...
    protected void drawFrames(GuiGraphicsExtractor guiGraphics, int backX, int backY, int mouseX, int mouseY) {
