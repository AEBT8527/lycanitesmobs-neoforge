...
public abstract class Tab extends ButtonBase {
	public Identifier texture = Identifier.parse("textures/gui/container/creative_inventory/tabs.png");
    ...
    public Tab(int id, int posX, int posY, Identifier icon, MutableComponent text, OnPress pressable) {
