...
public class MainTab extends Tab {
	...
	public MainTab(int id, OnPress pressable) {
        super(id, Tab.startX, Tab.startY, Identifier.fromNamespaceAndPath(LycanitesMobs.MODID, "textures/items/soulgazer.png"), Component.translatable("Index"), pressable);
    }

    public MainTab(int id, int x, int y, OnPress pressable) {
        super(id, x, y, Identifier.fromNamespaceAndPath(LycanitesMobs.MODID, "textures/items/soulgazer.png"), Component.translatable("Index"), pressable);
    }
