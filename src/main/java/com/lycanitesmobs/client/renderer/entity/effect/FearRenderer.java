...
public class FearRenderer extends EntityRenderer<EntityFear, net.minecraft.client.renderer.entity.state.EntityRenderState> {
    ...
    private static final Identifier WHITE_TEX =
            Identifier.fromNamespaceAndPath(LycanitesMobs.MODID, "textures/effect/white.png");
    ...
    private static FearRenderer activeInstance;
        ...
        public Identifier getTextureLocation(EntityFear entity) {
        return WHITE_TEX;
    }

        protected void renderLegacyUnused(EntityFear entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
       /* UUID id = entity.getUUID();
        ...
        RenderType renderType = CustomRenderStates.getFearRenderType(this.getTextureLocation(entity));
