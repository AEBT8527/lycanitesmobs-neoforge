...
public class BlockyRenderer extends MobRenderer<Mob, HierarchicalModel<Mob>> {
    ...
    @Override
    protected void setupRotations(Mob entity, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float scaleFactor) {
        super.setupRotations(entity, pPoseStack, pAgeInTicks, pRotationYaw, pPartialTicks, scaleFactor);
