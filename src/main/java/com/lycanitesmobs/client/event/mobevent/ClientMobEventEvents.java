...
public class ClientMobEventEvents {
    ...
    public static void onClientUpdate(ClientTickEvent.Post event) {
        ...
        Level world = ClientManager.getInstance().getClientPlayer().level();
    ...
    public static void render(Level world, GuiGraphicsExtractor guiGraphics, BaseOverlayScreen overlayScreen, int sWidth, int sHeight) {
        if (world == null || !world.isClientSide()) {
            return;
        }
