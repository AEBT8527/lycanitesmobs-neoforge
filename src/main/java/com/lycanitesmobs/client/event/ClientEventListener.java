...
public class ClientEventListener {
    ...
    public static void onRegisterClientReloadListeners(net.neoforged.neoforge.client.event.AddClientReloadListenersEvent event) {
        event.addListener(net.minecraft.resources.Identifier.fromNamespaceAndPath("lycanitesmobs", "language_loader"), LanguageLoader.getInstance());
        event.addListener(net.minecraft.resources.Identifier.fromNamespaceAndPath("lycanitesmobs", "model_reload"), ModelReloadListener.INSTANCE);
    }
    ...
    public static void registerGuiLayers(RegisterGuiLayersEvent event) {
        ...
        event.registerAbove(VanillaGuiLayers.EXPERIENCE_LEVEL,
                Identifier.fromNamespaceAndPath(LycanitesMobs.MODID, "hud"),
