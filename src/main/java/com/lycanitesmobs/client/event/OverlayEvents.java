...
public class OverlayEvents {
    ...
    //                  Draw Game Overlay
    // ==================================================
    public static void renderHud(net.minecraft.client.gui.GuiGraphics guiGraphics, net.minecraft.client.DeltaTracker deltaTracker) {
        ...
        matrixStack.pushPose();
        ClientMobEventEvents.render(player.getCommandSenderWorld(), guiGraphics, baseOverlayScreen, sWidth, sHeight);
        matrixStack.popPose();
...
//						.append(" ").append(Component.translatable("gui.mount.controls.dismount"));
            ...
            // 1.21 removed icons.png; draw with the vanilla jump-bar HUD sprites instead
            // (same 182x5 bar the horse jump meter uses).
            RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            RenderSystem.enableBlend();
            guiGraphics.blitSprite(BaseOverlayScreen.JUMP_BAR_BACKGROUND_SPRITE, staminaBarX, staminaBarY, staminaBarWidth, staminaBarHeight);
            if (staminaEnergyWidth > 0)
                guiGraphics.blitSprite(BaseOverlayScreen.JUMP_BAR_PROGRESS_SPRITE, staminaBarWidth, staminaBarHeight, 0, 0, staminaBarX, staminaBarY, Math.min(staminaEnergyWidth, staminaBarWidth), staminaBarHeight);
