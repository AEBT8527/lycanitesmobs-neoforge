...
public class VBOObjModel extends ObjModel {
    ...
    private static final com.mojang.blaze3d.vertex.ByteBufferBuilder IRIS_BYTE_BUFFER = new com.mojang.blaze3d.vertex.ByteBufferBuilder(65536);
    ...
    public void renderPart(VertexConsumer vertexBuilder, Matrix3f matrix3f, Matrix4f matrix4f,
        ...
        if (useEntityFormat && irisRenderType != null) {
            ...
            BufferBuilder irisBuf = new BufferBuilder(IRIS_BYTE_BUFFER, VertexFormat.Mode.TRIANGLES, DefaultVertexFormat.NEW_ENTITY);
            for (int i = 0; i < indices.length; i++) {
                ...
                irisBuf
                        .addVertex(v.getPos().x(), v.getPos().y(), v.getPos().z())
                        .setColor(255, 255, 255, 255)
                        .setUv(v.getTexCoords().x + texOX, 1f - (v.getTexCoords().y + texOY))
                        .setUv1(0, 10 - fade)
                        .setLight(brightness)
            ...
            irisTempVbo.bind();
            irisTempVbo.upload(irisBuf.buildOrThrow());
