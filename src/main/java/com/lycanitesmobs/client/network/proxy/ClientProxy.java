...
public class ClientProxy implements IProxy {
    ...
    public boolean isShiftKeyDown() {
        com.mojang.blaze3d.platform.Window lycWin = Minecraft.getInstance().getWindow();
        return com.mojang.blaze3d.platform.InputConstants.isKeyDown(lycWin, org.lwjgl.glfw.GLFW.GLFW_KEY_LEFT_SHIFT)
                || com.mojang.blaze3d.platform.InputConstants.isKeyDown(lycWin, org.lwjgl.glfw.GLFW.GLFW_KEY_RIGHT_SHIFT);
    }
